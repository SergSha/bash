...
<p>С помощью текстового редактора в файле <b><i>sendmaillog/scron.sh</i></b> в переменной <b><i>postmaillog</i></b> вствить свою электронную почту, на которую будет приходить сообщение логов:</p>
